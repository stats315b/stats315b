...
Here we can see our overall estimate of misclassification rate is .0397.  Our misclassification percentage for spam in the testing set is 5.66% and for not spam is 2.84%


## Part (B)

Now we will edit our weights to obtain our desired misclassification rates.
...
Now we see that with a very high relative cost we can reach the desired non-spam misclassification rate, but our overall misclassification rate has risen to .1578.  Our misclassification percentage for spam in the testing set is now 38.83% and for not spam is .22%
