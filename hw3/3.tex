...
\text{(where $\mathbf {R} \in  \mathcal{R}^{n \times n}$ is an upper triangular matrix obtained from} \\
\text {Cholesky factorization of positive definite matrix $\boldsymbol \Sigma $)}
